...
def estimate_next_pos(measurement, OTHER = None):
    ...
    p77 = []
    for i in range(N):
        p[i].move_in_circle()#move(random.gauss(p[i].turning,0.01),random.gauss(p[i].distance,0.01))
        #print(p[i].sense())
        p77.append(p[i])
    p = p77
    ...
    #        error = distance_between(current_measurement, measurement)  
    #        w.append((1/exp(error+0.01)))
    #        print(w[i])
    #    p3 = []
    ...
    #    p2 = []
    #    for i in range(len(p)):
    #        p[i].move_in_circle()#move(random.gauss(p[i].turning,0.1),random.gauss(p[i].distance,0.1))
    #        print(p[i].sense())
    #        p2.append(p[i])    
    #    p = p2
    #    
