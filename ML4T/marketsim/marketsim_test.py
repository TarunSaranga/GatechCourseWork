...
def compute_portvals(orders_file = "./orders/orders.csv", start_val = 1000000, commission=9.95, impact=0.005):  		   	  			  	 		  		  		    	 		 		   		 		  
    ...
    for idx2, row2 in orders_df.iterrows():
        order_price = prices[row2[0]].loc[idx2]
        order_units = row2[2]
        ...
        shares.loc[idx2,row2[0]] += order_units*sign*-1
        shares.loc[idx2,"Cash"] += order_units*order_price*sign
        shares.loc[idx2,"Cash"] -= commission
        share_impact = order_units*order_price*impact
        shares.loc[idx2,"Cash"] -= share_impact
